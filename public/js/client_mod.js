...
async function handleOnTrack(peer_id, peers) {
    ...
    let connn=peerConnections[peer_id]
    
    //console.log('[getSenders] - peer_id     ',peerConnections[peer_id].getRemoteStreams());
    peerConnections[peer_id]._ontrack = (event) => {
        console.log('[connn  ] ASDASDAS -   ',connn )
        //console.log('[connn  ] ASDASDAS -   ',connn)
...
async function msgerAddPeers(peers,config) {
    console.log("msgerAddPeers  peers   ", config);
